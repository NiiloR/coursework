...
The ![demo video](demo.mp4) from our group'stion showcases the simulation environment, the prototype game, and how to use them. The video demonstrates how users can move around and scan the environment while saving scanned data points for later use.
