...
const addProductToCart = productId => {
  ...
  if (!productCount) {
    ...
    window.sessionStorage.setItem(productId, parseInt(productCount)+1);
  }
...
const decreaseProductCount = productId => {
  ...
  if (productCount > 1) {
    ...
    //    key: productId
    //    data: productCount - 1
    window.sessionStorage.setItem(productId, productCount-1);
    newCount = window.sessionStorage.getItem(productId);
    return newCount;
  } else {
    // TODO 9.2 
